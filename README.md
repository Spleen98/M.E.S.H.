...
* Installation: Open your terminal (Command Prompt / PowerShell on Windows, Terminal on Mac) and run the following commands one by one.
(Note: We strongly recommend creating a virtual environment to avoid version conflicts).

# A. Navigate to the M.E.S.H. folder
# Type "cd " (with a space after cd), then drag and drop the M.E.S.H. folder from your file explorer directly into the terminal, and press Enter.
# It should look something like this:
cd /Users/YOUR_NAME/Downloads/M.E.S.H.
...
# C. Update basic installation tools
pip install --upgrade pip setuptools wheel

# D. Install the biometric analysis engine (MediaPipe)
pip install mediapipe==0.10.14

# E. Install vision (OpenCV) and network transmission (OSC) tools
